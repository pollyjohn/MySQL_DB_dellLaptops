...
ALTER TABLE `dellLaptops`.`screen_size` MODIFY COLUMN `size` DECIMAL(4,2) NOT NULL;
...
ALTER TABLE `dellLaptops`.`product_has_graphic_card` ADD COLUMN `graphic_card_id` INT NOT NULL;

-- creating foreign key on intermediate table  
ALTER TABLE `dellLaptops`.`product_has_graphic_card`
