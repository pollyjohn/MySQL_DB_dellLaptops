...
-- Schema dellLaptops
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dellLaptops` ;
-- -----------------------------------------------------
-- Schema Study
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `dellLaptops`.`product_has_graphic_card` (
  ...
  CONSTRAINT `fk_product_has_graphic_card_products1`
...
CREATE TABLE IF NOT EXISTS `dellLaptops`.`graphic_cards` (
  ...
  `product_has_graphic_card_products_id` INT NOT NULL,
  PRIMARY KEY (`id`, `product_has_graphic_card_products_id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  UNIQUE INDEX `graphic_card_model_UNIQUE` (`graphic_card_model` ASC) VISIBLE,
  INDEX `fk_graphic_cards_product_has_graphic_card1_idx` (`product_has_graphic_card_products_id` ASC) VISIBLE,
  CONSTRAINT `fk_graphic_cards_product_has_graphic_card1`
    FOREIGN KEY (`product_has_graphic_card_products_id`)
    REFERENCES `dellLaptops`.`product_has_graphic_card` (`products_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dellLaptops`.`memory` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `memory_size` INT ZEROFILL NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dellLaptops`.`Orders` (
  ...
  `screen_size` DECIMAL(3,3) NOT NULL,
  `resolution` VARCHAR(75) NOT NULL,
  `color` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
